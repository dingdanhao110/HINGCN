...
parser.add_argument('--dataset_path', type=str, default='../pygcn/data/cora/',
                    help='Dataset')
parser.add_argument('--num_metapath', type=int, default=1,
                    help='Dataset')
...
adjs, features, labels, idx_train, idx_val, idx_test \
    = read_metapath(path=args.dataset_path, dataset=args.dataset,
                    num_mps=args.num_metapath)

# Model and optimizer
model = HINGCN(nfeat=features.shape[1],
            nhid=args.hidden,
            nmeta=args.num_metapath,
