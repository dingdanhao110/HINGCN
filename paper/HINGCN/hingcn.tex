...
\affiliation{
  \institution{\textsuperscript{$*$}The University of Hong Kong, Pokfulam Road, Hong Kong SAR\\ \textsuperscript{$\dagger$}University of Ioannina, Ioannina, Greece}
...
\begin{abstract}
GCN on HIN. \dan{TODO: uniform terminology: GCNN; HIN vs. Heterogeneous graph;Embedding vs. graph representation learning }
\end{abstract}
...
%
\keywords{Semi-supervised classification; graph convolution neural networks; heterogeneous information network}
