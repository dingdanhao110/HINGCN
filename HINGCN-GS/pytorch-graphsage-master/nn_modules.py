...
class MetapathConcatLayer(nn.Module):
    ...
    def __init__(self, in_features, n_head=3, alpha=0.8, dropout=0.5, hidden_dim=64, batchnorm=False):
        ...
        if self.batchnorm:
            self.bn = nn.BatchNorm1d(hidden_dim * n_head)
...
class MetapathLSTMLayer(nn.Module):
    ...
    def __init__(self, in_features,n_head=4, alpha=0.8, dropout=0.5, hidden_dim=512, batchnorm=False, bidirectional=False):
